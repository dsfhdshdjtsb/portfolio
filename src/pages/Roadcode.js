    ...
    return(
        <div className="Roadcode">
            ...
            <ProjectEntry title="RoadcodeEntry" name="Randomized Roadtrips" awards="Best Overall" awards2="Best use of Digital Ocean" roles="Backend Dev"
                ...
                with points of interest, hotels, restaurants, and more. Roadcode was created at Freyhacks, a 48 hour online hackathon with over 500 participants. Developed in conjunction 
