    ...
    return(
        <div className="Metruhnome">
            ...
            <ProjectEntry title="MetruhnomeEntry" name="A Syncronized Metronome" roles="Backend Dev"
                ...
                have other users enter the room code, and Metruhnome will syncronize your metronome with everyone else's. Originally an idea given to me by my band director,
